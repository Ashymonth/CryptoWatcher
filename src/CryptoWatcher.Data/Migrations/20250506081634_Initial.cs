        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Token0Amount = table.Column<decimal>(type: "numeric", nullable: false),
                    Token1Amount = table.Column<decimal>(type: "numeric", nullable: false),
                    Token0PriceInUsd = table.Column<decimal>(type: "numeric", nullable: false),
                    Token1PriceInUsd = table.Column<decimal>(type: "numeric", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Token0PriceInUsd = table.Column<decimal>(type: "numeric", nullable: false),
                    Token1PriceInUsd = table.Column<decimal>(type: "numeric", nullable: false),
                    Token0FeesUnclaimed = table.Column<decimal>(type: "numeric", nullable: false),
                    Token1FeesUnclaimed = table.Column<decimal>(type: "numeric", nullable: false),
                    IsInRange = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
